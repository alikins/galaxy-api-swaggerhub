...
class V2Api(object):
    ...
    def get_collection_import_by_id(self, id, **kwargs):  # noqa: E501
        """Get a Collection-Import (import task) by id  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_collection_import_by_id(id, async_req=True)
        >>> result = thread.get()
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.get_collection_import_by_id_with_http_info(id, **kwargs)  # noqa: E501

    def get_collection_import_by_id_with_http_info(self, id, **kwargs):  # noqa: E501
        """Get a Collection-Import (import task) by id  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_collection_import_by_id_with_http_info(id, async_req=True)
        >>> result = thread.get()
        ...
        :param _request_timeout: timeout setting for this request. If one
                                 ...
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        :return: tuple(CollectionImportResult, status_code(int), headers(HTTPHeaderDict))
                 If the method is called asynchronously,
                 returns the request thread.
        """
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_collection_import_by_id" % key
                )
            local_var_params[key] = val
        del local_var_params['kwargs']
        # verify the required parameter 'id' is set
        if ('id' not in local_var_params or
                local_var_params['id'] is None):
            raise ApiValueError("Missing the required parameter `id` when calling `get_collection_import_by_id`")  # noqa: E501
        ...
        return self.api_client.call_api(
            ...
            post_params=form_params,
            files=local_var_files,
            response_type='CollectionImportResult',  # noqa: E501
            auth_settings=auth_settings,
            async_req=local_var_params.get('async_req'),
            _return_http_data_only=local_var_params.get('_return_http_data_only'),  # noqa: E501
            _preload_content=local_var_params.get('_preload_content', True),
    ...
    def get_collection_version_artifact_by_id(self, id, **kwargs):  # noqa: E501
        """get_collection_version_artifact_by_id  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_collection_version_artifact_by_id(id, async_req=True)
        >>> result = thread.get()
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.get_collection_version_artifact_by_id_with_http_info(id, **kwargs)  # noqa: E501

    def get_collection_version_artifact_by_id_with_http_info(self, id, **kwargs):  # noqa: E501
        """get_collection_version_artifact_by_id  # noqa: E501
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_collection_version_artifact_by_id" % key
                )
            local_var_params[key] = val
        del local_var_params['kwargs']
        # verify the required parameter 'id' is set
        if ('id' not in local_var_params or
                local_var_params['id'] is None):
            raise ApiValueError("Missing the required parameter `id` when calling `get_collection_version_artifact_by_id`")  # noqa: E501
    ...
    def get_collection_version_by_version_pk(self, version_pk, **kwargs):  # noqa: E501
        """Get a CollectionVersion by version_pk  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_collection_version_by_version_pk(version_pk, async_req=True)
        >>> result = thread.get()

        :param async_req bool: execute request asynchronously
        :param str version_pk: The CollectionVersion version_pk (required)
        :param _preload_content: if False, the urllib3.HTTPResponse object will
                                 be returned without reading/decoding response
                                 data. Default is True.
        :param _request_timeout: timeout setting for this request. If one
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.get_collection_version_by_version_pk_with_http_info(version_pk, **kwargs)  # noqa: E501

    def get_collection_version_by_version_pk_with_http_info(self, version_pk, **kwargs):  # noqa: E501
        """Get a CollectionVersion by version_pk  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_collection_version_by_version_pk_with_http_info(version_pk, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_collection_version_by_version_pk" % key
                )
            local_var_params[key] = val
        del local_var_params['kwargs']
        ...
        if ('version_pk' not in local_var_params or
            ...
            raise ApiValueError("Missing the required parameter `version_pk` when calling `get_collection_version_by_version_pk`")  # noqa: E501
