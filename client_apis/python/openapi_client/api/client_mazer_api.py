...
class ClientMazerApi(object):
    ...
    def download_artifact_by_filename(self, filename, **kwargs):  # noqa: E501
        """Download the collection artifact  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.download_artifact_by_filename(filename, async_req=True)
        >>> result = thread.get()

        :param async_req bool: execute request asynchronously
        :param str filename: CollectionVersion artifact filename (required)
        ...
        return self.download_artifact_by_filename_with_http_info(filename, **kwargs)  # noqa: E501

    def download_artifact_by_filename_with_http_info(self, filename, **kwargs):  # noqa: E501
        """Download the collection artifact  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.download_artifact_by_filename_with_http_info(filename, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(local_var_params['kwargs']):
            if key not in all_params:
                raise ApiTypeError(
                    ...
                    " to method download_artifact_by_filename" % key
                )
        ...
        if ('filename' not in local_var_params or
            ...
            raise ApiValueError("Missing the required parameter `filename` when calling `download_artifact_by_filename`")  # noqa: E501
